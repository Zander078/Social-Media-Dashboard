    ...
    >
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-white dark:text-white light:text-gray-800 font-bold text-xl">SocialHub</h1>
            <p className="text-white/60 dark:text-white/60 light:text-gray-600 text-sm">Dashboard</p>
          </div>
        </div>
        <ThemeToggle />
      </div>
      ...
      <div className="mt-8 p-4 glass rounded-xl">
        <div className="flex items-center gap-3">
          ...
          />
          <div>
            <p className="text-white dark:text-white light:text-gray-800 font-medium text-sm">Alex Johnson</p>
            <p className="text-white/60 dark:text-white/60 light:text-gray-600 text-xs">Social Manager</p>
          </div>
        </div>
      </div>
    </motion.aside>
